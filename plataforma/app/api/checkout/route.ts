...
import { MercadoPagoError, criarCobrancaPix, mercadoPagoConfigurado } from "@/lib/mercadopago";
import {
  arredondar,
  calcularFrete,
  esgotado,
...
export async function POST(request: Request) {
  ...
  if (erroPix) {
    ...
    // Não cancelamos: o webhook (Prompt 7) ainda confirma pelo external_reference.
